---
title: "Keyword Engine Migration — Usage Guide"
status: active
category: guide
last-updated: 2026-03-20
depends-on: ["KEYWORD-ENGINE-MIGRATION"]
---

# Keyword Engine Migration — Usage Guide

> **Status: COMPLETED** — All steps executed. See `logs/KEYWORD-ENGINE-LOG.md` for results.
>
> 如何用 Claude Code 逐步执行 migration plan。
> 配合 `docs/specs/migration/KEYWORD-ENGINE-MIGRATION.md` 使用。
...
4. 验证通过 → commit + push
5. 记录到 Execution Log（docs/logs/KEYWORD-ENGINE-LOG.md）
6. 下一个模块
```
...
参考：
- @docs/specs/STRATEGY.md §4.4-4.5 的数据模型
- @docs/specs/migration/KEYWORD-ENGINE-MIGRATION.md Phase A
```
...
2. 写 spec 到 docs/specs/discovery/SPEC-A2-serper.md
3. Spec 必须包含：
...
参考文档：
- @docs/specs/migration/KEYWORD-ENGINE-MIGRATION.md Phase A → A2
- @docs/specs/STRATEGY.md §4.3-4.4
...
**Step 2b — 执行 Spec：**
```
请执行 @docs/specs/discovery/SPEC-A2-serper.md 。
...
4. npm run build 通过
5. Commit + push
6. 在 @docs/logs/KEYWORD-ENGINE-LOG.md 记录结果（参考 log 格式见 @docs/guides/KEYWORD-ENGINE-USAGE.md 底部）
```
...
2. 写 spec 到 docs/specs/discovery/SPEC-A3-exa.md
3. Spec 必须包含：
...
参考文档：
- @docs/specs/migration/KEYWORD-ENGINE-MIGRATION.md Phase A → A3
- @docs/specs/STRATEGY.md §4.3-4.4
...
**Step 3b — 执行 Spec：**
```
请执行 @docs/specs/discovery/SPEC-A3-exa.md 。
...
2. 写 spec 到 docs/specs/discovery/SPEC-A4-gsc.md
3. Spec 必须包含：
...
参考文档：
- @docs/specs/migration/KEYWORD-ENGINE-MIGRATION.md Phase A → A4
- @docs/specs/STRATEGY.md §4.9
...
**Step 4b — 执行 Spec：**
```
请执行 @docs/specs/discovery/SPEC-A4-gsc.md 。
...
要求：
1. 写 spec 到 docs/specs/content/SPEC-B1-keyword-expansion.md
...
**Step 5b — 执行 Spec：**
```
请执行 @docs/specs/content/SPEC-B1-keyword-expansion.md 。
...
要求：
1. 写 spec 到 docs/specs/content/SPEC-B2-keyword-grouping.md
...
8. 参考 @docs/specs/STRATEGY.md §4.4 的 grouping 示例

参考文档：
- @docs/specs/migration/KEYWORD-ENGINE-MIGRATION.md Phase B → B2
...
**Step 6b — 执行 Spec：**
```
请执行 @docs/specs/content/SPEC-B2-keyword-grouping.md 。
...
要求：
1. 写 spec 到 docs/specs/content/SPEC-B3-priority-scoring.md
...
5. 参考 @docs/specs/STRATEGY.md §4.5

参考文档：
- @docs/specs/migration/KEYWORD-ENGINE-MIGRATION.md Phase B → B3
...
**Step 7b — 执行 Spec：**
```
请执行 @docs/specs/content/SPEC-B3-priority-scoring.md 。
...
要求：
1. 写 spec 到 docs/specs/content/SPEC-B4-content-generation.md
...
参考文档：
- @docs/specs/migration/KEYWORD-ENGINE-MIGRATION.md Phase B → B4
- @docs/specs/STRATEGY.md §4.6-4.7
...
**Step 8b — 执行 Spec：**
```
请执行 @docs/specs/content/SPEC-B4-content-generation.md 。
...
要求：
1. 写 spec 到 docs/specs/performance/SPEC-C1-discovery-cycle.md
...
6. 参考 @docs/specs/STRATEGY.md §4.3 和 §4.10

参考文档：
- @docs/specs/migration/KEYWORD-ENGINE-MIGRATION.md Phase C → C1
...
**Step 9b — 执行 Spec：**
```
请执行 @docs/specs/performance/SPEC-C1-discovery-cycle.md 。
...
参考：
- @docs/specs/STRATEGY.md §4.8 和 §9
- @docs/specs/migration/KEYWORD-ENGINE-MIGRATION.md Phase C → C2
...
要求：
1. 写 spec 到 docs/specs/performance/SPEC-C3-performance-loop.md
...
7. 参考 @docs/specs/STRATEGY.md §4.9

参考文档：
- @docs/specs/migration/KEYWORD-ENGINE-MIGRATION.md Phase C → C3
- @scripts/lib/db.ts （create_queue 表结构）
...
**Step 11b — 执行 Spec：**
```
请执行 @docs/specs/performance/SPEC-C3-performance-loop.md 。
...
参考：
- @docs/specs/migration/KEYWORD-ENGINE-MIGRATION.md Phase C → C4
- @scripts/lib/db.ts （create_queue 表结构）
```
...
所有执行结果记录在 `@docs/logs/KEYWORD-ENGINE-LOG.md`，每个 step 追加：
