---
title: "Keyword-Centric Engine Migration Plan"
status: active
category: spec
...
> **Status: COMPLETED** — All phases (A1–C3) executed 2026-03-20. See `docs/logs/KEYWORD-ENGINE-LOG.md` for execution details.
> This document is preserved as an architectural reference.

## Context

LoreAI 需要从 **newsletter-led publishing system** 转型为 **flagship-topic-led keyword authority system**（详见 `docs/specs/STRATEGY.md`）。
