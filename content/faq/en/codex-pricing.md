...
slug: codex-pricing
description: "Codex is included with ChatGPT Pro, Business, and Enterprise plans. API pricing starts at $1.50/M input tokens."
category: tools
...
**[Codex](/glossary/codex)** is bundled into existing ChatGPT plans — there is no separate subscription. ChatGPT Pro, Business, Enterprise, and Plus users all have access at no additional cost during the initial rollout period. OpenAI has stated it will introduce rate-limited access and flexible on-demand pricing options after this introductory phase, but specific tier pricing has not been publicly documented yet.

## Context

Codex's pricing model splits into two tracks: the ChatGPT-integrated product and the API.
...
**Free API credits:** Plus subscribers who sign into Codex CLI with their ChatGPT account can redeem $5 in free API credits, while Pro subscribers get $50 — both valid for 30 days.
...
4. **Using Codex CLI?** Sign in with your ChatGPT account to automatically redeem your free API credits ($5 for Plus, $50 for Pro)
