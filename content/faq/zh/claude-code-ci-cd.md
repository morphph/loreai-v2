...
description: "Claude Code 通过 headless 模式和 SDK 接入 CI/CD 流水线，实现自动化代码审查、测试生成和文档检查，让每个 PR 都有 AI 把关。"
category: tools
...
4. **定义规范**：在仓库根目录放一个 `CLAUDE.md`，写清楚团队编码规范，Claude Code 会自动按规范执行
...
- [Claude Code Agent Teams 怎么用？](/faq/claude-code-agent-teams)
