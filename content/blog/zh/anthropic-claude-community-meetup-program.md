...
Anthropic 开发者关系团队的 Lydia Hallie 在社交媒体上公开招募社区组织者。计划的核心很直白：你来组织聚会，Anthropic 出钱。具体支持包括三部分：
...
AI 开发者工具的竞争已经进入生态战。光有好产品不够，还要让开发者形成社区、建立习惯、产生网络效应。
...
虽然这不是一个技术发布，但社区计划背后的 API 额度机制值得关注。

Anthropic 给组织者提供的是**月度 API credits**，不是一次性的。这意味着组织者可以持续用 Claude API 构建项目和 demo。对于想在聚会上做现场演示的组织者来说，这降低了成本门槛。
...
从 Ramp、Shopify、Spotify 等企业的 Claude Code 实践来看，工程团队已经在生产环境中大规模使用。社区聚会是让这些实践经验从企业内部流向更广泛开发者群体的渠道。

## 你现在该做什么

1. **如果你所在城市还没有 Claude 聚会**，考虑申请成为组织者。联系 Anthropic 开发者关系团队（关注 [@lydiahallie](https://x.com/lydiahallie) 获取申请方式）获取更多信息。
2. **已有 AI 社区的组织者**可以把 Claude 作为主题之一纳入活动，然后申请 Anthropic 的支持。
3. **准备分享素材**：整理你的 Claude Code 工作流、[MCP](/glossary/mcp) 集成方案或 prompt 技巧，这些是最受欢迎的聚会内容。
4. **关注国内社区动态**：虽然官方计划的国内落地还不明确，但深圳、上海、北京的 AI 开发者社区已经有不少 Claude 用户，自发组织也是一个选项。

**相关阅读**：[今日简报](/newsletter/2026-03-11) 有更多 Claude 生态动态。另见：[Claude Code 企业工程实践](/blog/claude-code-enterprise-engineering-ramp-shopify-spotify)。
