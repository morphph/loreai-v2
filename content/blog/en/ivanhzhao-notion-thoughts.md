...
1. **Bicycle** — Human does the work, computer assists (current state for most knowledge workers)
2. **Car** — Human drives, AI agents execute (where programmers are today)
3. **Self-driving** — AI executes autonomously, human supervises (where programmers are heading)
...
1. **Audit your context fragmentation.** Map where your team's knowledge actually lives — Slack, docs, dashboards, email, people's heads. The more scattered it is, the harder it is for AI agents to help. Consolidation isn't glamorous work, but it's the prerequisite.

2. **Build verifiability into knowledge work.** Create rubrics, checklists, and evaluation criteria for non-code outputs. If you can't define what "good" looks like for a task, neither can an AI — and you can't improve the AI's performance on it.

3. **Move from in-the-loop to over-the-loop.** Start with low-stakes tasks: let agents draft, then review in batches. Resist the urge to watch every step. The goal is supervision, not surveillance.

4. **Watch Notion's product roadmap closely.** Zhao's essay reads like a product strategy document. Expect Notion to ship deeper agent integration and cross-tool context consolidation in 2026.

**Related**: [Today's newsletter](/newsletter/2026-03-10) covers more AI industry analysis. See also: [What Are AI Agents](/glossary/ai-agent) for background on the agent paradigm Zhao describes.
