...
支持这种工作方式的工具包括 [ChatGPT](/glossary/chatgpt)、[Claude Desktop](/glossary/claude-desktop) 以及各种 IDE 插件。与传统的代码补全不同，vibe coding 强调的是**意图驱动**——开发者关注"要什么"，AI 负责"怎么做"。更进一步的[agentic coding](/glossary/agentic-coding) 则让 AI 自主完成多步骤的完整开发任务。

## 相关术语

- **[Agentic Coding](/glossary/agentic-coding)**：vibe coding 的进阶形态，AI 不仅生成代码，还能自主规划、执行和调试整个开发流程
- **[ChatGPT](/glossary/chatgpt)**：最早被广泛用于 vibe coding 的对话式 AI 工具之一
- **[Claude Desktop](/glossary/claude-desktop)**：Anthropic 的桌面端 AI 助手，支持通过自然语言与本地文件和应用交互
