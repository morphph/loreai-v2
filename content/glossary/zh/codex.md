...
**[Codex](/zh/blog/codex-complete-guide)** 是 OpenAI 基于 GPT 系列开发的代码生成模型，也是 [GitHub Copilot](/zh/glossary/github-[copilot](/zh/glossary/copilot)) 最初版本背后的核心引擎。它能根据自然语言描述生成代码，支持 Python、JavaScript、Go 等数十种编程语言，是最早将大语言模型能力大规模应用于软件开发的产品之一。
...
如今 OpenAI 已将 Codex 的能力整合进更新的模型中，但它对行业的影响持续存在。关于当前 AI 编码工具的最新动态，可以参考我们的[每日简报](/blog/anthropic-[cowork](/zh/blog/anthropic-cowork-claude-desktop-agent)-claude-desktop-agent)。
