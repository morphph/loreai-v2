...
slug: anthropic
description: >-
  What is Anthropic? The AI safety company behind Claude, focused on building
...
**Anthropic** is an [AI safety](/glossary/ai-safety) company that builds frontier [large language models](/blog/gemini-3-1-pro-complex-tasks), most notably the [Claude](/glossary/claude) family. Founded in 2021 by Dario Amodei, Daniela Amodei, and several former OpenAI researchers, the company focuses on developing AI systems that are safe, steerable, and interpretable. Anthropic is headquartered in San Francisco.

## Why Anthropic Matters

Anthropic occupies a unique position in the AI landscape: it competes directly with [OpenAI](/glossary/openai) and [Google DeepMind](/glossary/google-[deepmind](/glossary/deepmind)) on model capabilities while centering its research agenda on AI safety. The company's Constitutional AI technique — training models to follow a set of principles rather than relying purely on human feedback — has influenced how the industry thinks about alignment.
...
Anthropic trains large transformer-based language models using a combination of RLHF ([reinforcement learning](/glossary/reinforcement-learning) from human feedback) and Constitutional AI (CAI). Key technical contributions include:
