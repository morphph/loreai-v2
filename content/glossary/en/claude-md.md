...
slug: claude-md
description: >-
  What is CLAUDE.md? A project-level instruction file that gives Claude Code
...
- **[Anthropic](/glossary/anthropic)**: The [AI safety](/glossary/ai-safety) company behind Claude Code and the CLAUDE.md convention
