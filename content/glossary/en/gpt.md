...
- **[Fine-tuning](/glossary/fine-tuning)**: The process of training a pre-trained model like GPT-5.4 on domain-specific data to improve performance on targeted tasks
- **[Cursor](/glossary/cursor)**: An AI-powered IDE that supports GPT-5.4 as one of its available model backends for code generation and editing
