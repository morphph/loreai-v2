...
slug: fine-tuning
description: >-
  What is fine-tuning? The process of training a pre-trained AI model on
  task-specific data to improve its performance.
term: fine-tuning
...
- **[RLHF](/glossary/rlhf) ([Reinforcement Learning](/glossary/reinforcement-learning) from Human Feedback)**: A specialized fine-tuning stage where human preference rankings guide the model toward more helpful, harmless outputs. This is how most chat-oriented models are aligned after pre-training.
