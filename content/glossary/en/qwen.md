...
slug: qwen
description: >-
  What is Qwen? Alibaba Cloud's open-weight large language model family for
...
**Qwen** (通义千问) is Alibaba Cloud's family of open-weight [large language models](/blog/gemini-3-1-pro-complex-tasks), spanning text generation, code, math, vision, and audio. Developed by Alibaba's DAMO Academy, the Qwen series includes models ranging from under 1 billion to over 100 billion parameters, released under permissive licenses that allow commercial use. The latest generation, Qwen 2.5, competes directly with leading [open-weight models](/glossary/open-weight-models) like Llama and Mistral across standard benchmarks.
...
- **Deployment**: Available on [Hugging Face](/glossary/hugging-face), ModelScope, and through Alibaba Cloud's API service, with GGUF and AWQ quantized variants for local inference
...
- **[Agentic](/glossary/agentic)**: Autonomous AI workflows where models plan and execute multi-step tasks — Qwen's instruction-tuned variants support [tool use](/glossary/tool-use) for [agentic](/topics/agentic) applications
