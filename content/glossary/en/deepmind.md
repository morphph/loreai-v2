...
DeepMind operates at the frontier of AI research, consistently publishing work that reshapes what's considered possible. AlphaGo's 2016 victory over world Go champion Lee Sedol demonstrated that AI could master complex strategic reasoning. AlphaFold solved the 50-year-old protein folding problem, earning a Nobel Prize in Chemistry in 2024 — a first for AI-driven research.

As Google DeepMind, the lab now builds the Gemini models that power Google's AI products, putting it in direct competition with [Anthropic](/glossary/anthropic) (Claude) and OpenAI (GPT). Its research spans reinforcement learning, neuroscience-inspired architectures, and [agentic](/glossary/agentic) AI systems.
...
- **Gemini**: Multimodal large language models trained natively on text, image, audio, and video — Google's answer to [Claude](/glossary/claude) and GPT-4
- **Scalable agent research**: Work on generalist agents (Gato, SIMA) that operate across multiple environments and modalities
