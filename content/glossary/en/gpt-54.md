...
- **[GPT-5](/glossary/gpt-5)**: The major model generation that GPT-5.4 belongs to, establishing the base architecture and capability tier
- **[OpenAI](/glossary/openai)**: The AI research company that develops and operates the GPT model family
- **[Large Language Model](/glossary/large-language-model)**: The class of neural networks that GPT-5.4 belongs to, trained on large text corpora to generate and understand language
