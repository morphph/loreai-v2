...
For developers, Claude's extended context windows (up to 200K tokens), strong instruction-following, and tool use capabilities make it a foundation for building AI-powered applications. Anthropic has expanded Claude's reach beyond chat into [agentic desktop workflows](/blog/anthropic-cowork-claude-desktop-agent) and persistent [memory features](/blog/anthropic-claude-memory-upgrades-importing) that maintain context across conversations.
...
- **[Anthropic](https://anthropic.com)**: The AI safety company behind Claude, founded by former OpenAI researchers
