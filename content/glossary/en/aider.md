...
slug: aider
description: >-
  What is Aider? An open-source terminal AI pair programming tool that edits
  code and commits changes in your local git repo.
term: aider
display_term: Aider
category: tools
related_glossary:
...
**Aider** is an open-source AI pair programming tool that runs in your terminal and directly edits code in your local git repository. Created by Paul Gauthier, it connects to [large language models](/blog/gemini-3-1-pro-complex-tasks) — including GPT-4, Claude, and open-source models — to translate natural language instructions into working code changes, automatically creating git commits for each modification.
...
- **Multi-model support**: Works with OpenAI, Anthropic, and any OpenAI-compatible API endpoint, including local models via [Ollama](/glossary/ollama) or LiteLLM
...
- **[Claude Code](/glossary/claude-code)**: Anthropic's terminal-based AI coding agent — similar [agentic](/topics/agentic) approach with deeper shell access and multi-step task execution
