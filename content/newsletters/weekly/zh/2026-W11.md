...
- **Claude Code 七层架构深度解析** — Claude Code 有七层，99% 的人只用了第一层。从工具使用者到系统设计者，逐层拆解。 [阅读 ->](/zh/blog/claude-code-seven-programmable-layers)
...
- **Claude Code Agent 工具设计** — 一个提问工具迭代三版，Claude Code 团队踩过的坑比你想的多。 [阅读 ->](/zh/blog/lessons-from-building-claude-code-agent-tools)
